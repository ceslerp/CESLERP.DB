...
VALUES (
    'ContractRenewalApproved',
    N'Contract Renewal Approved',
    N'ProjectNotifications.html',

    -- Data Query
    N'SELECT 
        ''Contract Renewal Approved'' AS Subject,
        CONCAT(
            ...
            CHAR(13) + CHAR(10) + CHAR(13) + CHAR(10),
            ''This contract renewal has been successfully processed in the system.''
        ) AS BodyData,
